...
Функционал:  Подготовка данных для документа Заказа 
 

Сценарий: Загрузка  (Подготовка) данных для документа  Заказа
	// Справочник.Валюты
